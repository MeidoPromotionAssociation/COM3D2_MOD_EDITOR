...
import {Button, Checkbox, Collapse, ConfigProvider, Form, FormListFieldData, Input, message, Radio, Space} from "antd";
...
import DynamicColliderFormItem from "./col/DynamicColliderFormItem";
